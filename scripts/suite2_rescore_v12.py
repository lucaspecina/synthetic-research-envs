...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v12.json
  - research/synthesis/compiler_baseline_full_dump_v12.jsonl
  - research/synthesis/compiler_baseline_failures_v12.json
"""
...
V4_PATH = Path("research/synthesis/compiler_baseline_full_dump_v11.jsonl")
OUT_JSON = Path("research/synthesis/compiler_baseline_full_dump_v12.json")
OUT_JSONL = Path("research/synthesis/compiler_baseline_full_dump_v12.jsonl")
OUT_FAIL = Path("research/synthesis/compiler_baseline_failures_v12.json")
...
def main() -> None:
    ...
    print("=" * 60)
    print("v12 rescore (v11 LLM dump + coverage-matcher + new prompts)")
    print("=" * 60)
