"""Delta analysis: v2 (pre-compiler-fix) vs v3 (post-compiler-fix) Suite 2 dump.
...
Writes:
  research/synthesis/compiler_baseline_delta_v2_v3.json
  research/synthesis/compiler_baseline_delta_v2_v3.md (human-readable)
"""
...
V2_PATH = Path("research/synthesis/compiler_baseline_full_dump_v2.json")
V3_PATH = Path("research/synthesis/compiler_baseline_full_dump_v3.json")
OUT_JSON = Path("research/synthesis/compiler_baseline_delta_v2_v3.json")
OUT_MD = Path("research/synthesis/compiler_baseline_delta_v2_v3.md")
...
def main() -> None:
    ...
    # Markdown report
    lines: list[str] = []
    lines.append("# Suite 2 Compiler Baseline Delta — v2 vs v3")
    lines.append("")
    lines.append(f"Targets compared: {n}")
    lines.append("")
    lines.append("## Pass rates")
    lines.append("")
    lines.append("| metric | v2 | v3 | Delta (pp) |")
    lines.append("|---|---|---|---|")
    lines.append(
    ...
    lines.append("")
    lines.append("| bucket | v2 | v3 | Delta |")
    lines.append("|---|---|---|---|")
