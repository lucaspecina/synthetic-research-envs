...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v9.json
  - research/synthesis/compiler_baseline_full_dump_v9.jsonl
  - research/synthesis/compiler_baseline_failures_v9.json
"""
...
OUT_JSON = Path("research/synthesis/compiler_baseline_full_dump_v9.json")
OUT_JSONL = Path("research/synthesis/compiler_baseline_full_dump_v9.jsonl")
OUT_FAIL = Path("research/synthesis/compiler_baseline_failures_v9.json")
...
def main() -> None:
    ...
    print("=" * 60)
    print("v9 rescore summary (v8 LLM dump + sweep_var evaluator fix + current golds)")
    print("=" * 60)
