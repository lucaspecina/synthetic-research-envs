"""Full per-target dump for Suite 2 — v4 (post coverage-matcher + tail_prob/ATE disambig (2026-04-19)).
...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v11.json
  - research/synthesis/compiler_baseline_failures_v11.json
  - research/synthesis/compiler_baseline_full_dump_v11.jsonl (streaming log)
...
OUT_FULL = Path("research/synthesis/compiler_baseline_full_dump_v11.json")
OUT_FAILS = Path("research/synthesis/compiler_baseline_failures_v11.json")
