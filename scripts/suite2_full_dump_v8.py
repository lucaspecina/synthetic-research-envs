"""Full per-target dump for Suite 2 — v4 (post Recipe J + G-simple (2026-04-19)).
...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v8.json
  - research/synthesis/compiler_baseline_failures_v8.json
  - research/synthesis/compiler_baseline_full_dump_v8.jsonl (streaming log)
...
OUT_FULL = Path("research/synthesis/compiler_baseline_full_dump_v8.json")
OUT_FAILS = Path("research/synthesis/compiler_baseline_failures_v8.json")
