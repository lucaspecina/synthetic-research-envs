"""Full per-target dump for Suite 2 — v4 (post Task #3.5).

v4 measures the effect of escape-hatch hardening + Recipe G (mediation)
added after the v3 baseline (epic #36):
...
Outputs:
  ...
  - research/synthesis/compiler_baseline_failures_v4.json
  - research/synthesis/compiler_baseline_full_dump_v4.jsonl (streaming log)
...
OUT_FULL = Path("research/synthesis/compiler_baseline_full_dump_v4.json")
OUT_FAILS = Path("research/synthesis/compiler_baseline_failures_v4.json")
