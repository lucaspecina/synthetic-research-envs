...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v13.json
  - research/synthesis/compiler_baseline_full_dump_v13.jsonl
  - research/synthesis/compiler_baseline_failures_v13.json
"""
...
OUT_JSON = Path("research/synthesis/compiler_baseline_full_dump_v13.json")
OUT_JSONL = Path("research/synthesis/compiler_baseline_full_dump_v13.jsonl")
OUT_FAIL = Path("research/synthesis/compiler_baseline_failures_v13.json")
...
def main() -> None:
    ...
    print("=" * 60)
    print("v13 rescore (v11 LLM dump + coverage-matcher + new prompts)")
    print("=" * 60)
