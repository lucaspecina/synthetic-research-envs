...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v16.json
  - research/synthesis/compiler_baseline_full_dump_v16.jsonl
  - research/synthesis/compiler_baseline_failures_v16.json
"""
...
V4_PATH = Path("research/synthesis/compiler_baseline_full_dump_v15.jsonl")
OUT_JSON = Path("research/synthesis/compiler_baseline_full_dump_v16.json")
OUT_JSONL = Path("research/synthesis/compiler_baseline_full_dump_v16.jsonl")
OUT_FAIL = Path("research/synthesis/compiler_baseline_failures_v16.json")
...
def main() -> None:
    ...
    print("=" * 60)
    print("v16 rescore (v11 LLM dump + coverage-matcher + new prompts)")
    print("=" * 60)
