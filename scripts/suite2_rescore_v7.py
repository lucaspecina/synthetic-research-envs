...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v7.json
  - research/synthesis/compiler_baseline_full_dump_v7.jsonl
  - research/synthesis/compiler_baseline_failures_v7.json
"""
...
OUT_JSON = Path("research/synthesis/compiler_baseline_full_dump_v7.json")
OUT_JSONL = Path("research/synthesis/compiler_baseline_full_dump_v7.jsonl")
OUT_FAIL = Path("research/synthesis/compiler_baseline_failures_v7.json")
...
def main() -> None:
    ...
    print("=" * 60)
    print("v7 rescore summary (SQ_F01 gold hygiene + W2_F02 from v5)")
    print("=" * 60)
