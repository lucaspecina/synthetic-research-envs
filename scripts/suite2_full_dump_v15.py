"""Full per-target dump for Suite 2 — v4 (post Flow-A abstain section 6 + per-unit scaling + modifier focus (2026-04-19)).
...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v15.json
  - research/synthesis/compiler_baseline_failures_v15.json
  - research/synthesis/compiler_baseline_full_dump_v15.jsonl (streaming log)
...
OUT_FULL = Path("research/synthesis/compiler_baseline_full_dump_v15.json")
OUT_FAILS = Path("research/synthesis/compiler_baseline_failures_v15.json")
