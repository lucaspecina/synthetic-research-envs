...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v14.json
  - research/synthesis/compiler_baseline_full_dump_v14.jsonl
  - research/synthesis/compiler_baseline_failures_v14.json
"""
...
OUT_JSON = Path("research/synthesis/compiler_baseline_full_dump_v14.json")
OUT_JSONL = Path("research/synthesis/compiler_baseline_full_dump_v14.jsonl")
OUT_FAIL = Path("research/synthesis/compiler_baseline_failures_v14.json")
...
def main() -> None:
    ...
    print("=" * 60)
    print("v14 rescore (v11 LLM dump + coverage-matcher + new prompts)")
    print("=" * 60)
