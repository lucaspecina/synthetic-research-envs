...
Outputs:
  - research/synthesis/compiler_baseline_full_dump_v10.json
  - research/synthesis/compiler_baseline_full_dump_v10.jsonl
  - research/synthesis/compiler_baseline_failures_v10.json
"""
...
V4_PATH = Path("research/synthesis/compiler_baseline_full_dump_v8.jsonl")
OUT_JSON = Path("research/synthesis/compiler_baseline_full_dump_v10.json")
OUT_JSONL = Path("research/synthesis/compiler_baseline_full_dump_v10.jsonl")
OUT_FAIL = Path("research/synthesis/compiler_baseline_failures_v10.json")
...
def _signatures_compatible(gold_sig, compiler_sig) -> bool:
    g_arms, g_meas, g_cmp, g_assert = gold_sig
    c_arms, c_meas, c_cmp, c_assert = compiler_sig
    if g_meas != c_meas or g_cmp != c_cmp or g_assert != c_assert:
        return False
...
def main() -> None:
    ...
    print("=" * 60)
    print("v10 rescore summary (v8 LLM dump + coverage-matcher stage 2)")
    print("=" * 60)
