# SREG v1.5 — Architecture (spec vivo)

> **Estado:** propuesta de diseño. Working canon hasta que primer MVP
> end-to-end corra. Si algo de esto no sobrevive a contacto con
> código real, se actualiza acá.
>
> **Rama de desarrollo:** `dev`. `main` queda congelada en v1.x con
> tag `pre-v1.5` como referencia estable.
>
