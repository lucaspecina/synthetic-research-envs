...
La verdad oculta es una red bayesiana — el reward es matemático, sin jueces
...
|--------|----------|----------|
| **Models** | `src/sreg/models/` | Contratos de datos (Pydantic): World, Episode, Task, Score, ResearchProblem, DAGSpec, CasePlan, AgentTool/Toolset, BenchmarkResult/Comparison, CodeExecConfig/Result, EnvAction/Observation/StepResult |
...
- Validaciones clave:
  ...
  - S.4 MVP-1: 8 tests (research_action dispatch, invalid/already-used IDs, action IDs stable, full loop)
