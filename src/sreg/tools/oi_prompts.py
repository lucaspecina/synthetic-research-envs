...
def build_oi_tools_section(artifact_catalog: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        "Submit your research findings as atomic claim cards. Each claim "
...
def build_oi_strategy_section() -> str:
    ...
    return (
        ...
        "4. REPORT: Submit when you have a set of atomic claims (one "
        "assertion each), each tied to concrete artifacts, and any "
        "causal/mechanistic claim has at least one robustness or "
