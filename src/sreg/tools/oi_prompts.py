...
def build_oi_tools_section(artifact_catalog: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        "Load a dataset by its ID. Returns a pandas DataFrame. You must use "
        "this to access data -- datasets are not pre-loaded.\n\n"
        "Available artifacts:\n"
        f"{catalog_text}\n\n"
        "### python_exec(code)\n"
        "Execute Python code. numpy, pandas, scipy, math, statistics are "
        "available. Use this for all analysis.\n\n"
