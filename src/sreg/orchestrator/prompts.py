...
(infer_target, next_best_observation, hypothesis_selection, causal_effect, best_intervention, adjustment_set, compare_interventions, or should_condition) and a target_node. \
