...
from sreg.agent.python_exec import make_python_namespace  # noqa: E402
...
def _build_python_namespace(
    ...
    Delegates to the shared make_python_namespace from agent/python_exec.py
    to ensure identical semantics between diagnostic and training.
    """
    # Convert initial_evidence to observations dict
    ...
    return make_python_namespace(data_assets=data_assets, observations=observations)
